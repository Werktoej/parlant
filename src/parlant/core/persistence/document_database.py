...
class FindResult(Generic[TDocument]):
    """Result of a find operation with pagination support.

    Attributes:
        items: The documents returned in this page.
        total_count: Total number of documents matching the query (in this page).
        has_more: Whether there are more documents after this page.
        next_cursor: Cursor to fetch the next page, if has_more is True.
    """
    ...
    def create(
        ...
        """Create a FindResult with automatic cursor generation.

        Args:
            items: The documents to include in the result.
            total_count: Total count of documents.
            limit: The limit used in the query.

        Returns:
            A FindResult with has_more and next_cursor computed automatically.
        """
